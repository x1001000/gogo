...
cv2.createTrackbar('hl', 'result', 170,  359, nothing)
cv2.createTrackbar('hu', 'result', 180,  359, nothing)
cv2.createTrackbar('sl', 'result', 40,  100, nothing)
cv2.createTrackbar('su', 'result', 85, 100, nothing)
cv2.createTrackbar('vl', 'result', 34,   100, nothing)
...
while True:
    try:
        ...
        vl,vu=0,100'''
        '''
        # tiffany blue(green) chasing taipei @.@
        hl,hu=170,180 
        sl,su=40,85
        vl,vu=34,100'''
